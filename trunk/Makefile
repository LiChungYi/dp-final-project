...
FBmain:	 json.o Adapter.o Data.hpp User.hpp Post.hpp SearchEngine.hpp Filter.hpp FBmain.cpp
	g++ -Wall -O3 FBmain.cpp json.o Adapter.o -o FBmain 
TWFunc1: json.o Adapter.o Data.hpp User.hpp Post.hpp SearchEngine.hpp Filter.hpp TwitterFunc1.cpp 
